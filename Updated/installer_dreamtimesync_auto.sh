...
#
# Example run:
# wget -qO- "https://raw.githubusercontent.com/Saiedf/DreamTimeSync/main/installer_dreamtimesync_auto.sh?nocache=$(date +%s)" | /bin/sh
#
# Alternative:
# wget -O /tmp/installer_dreamtimesync_auto.sh "https://raw.githubusercontent.com/Saiedf/DreamTimeSync/main/installer_dreamtimesync_auto.sh?nocache=$(date +%s)" && chmod 755 /tmp/installer_dreamtimesync_auto.sh && /bin/sh /tmp/installer_dreamtimesync_auto.sh
# ==========================================================
